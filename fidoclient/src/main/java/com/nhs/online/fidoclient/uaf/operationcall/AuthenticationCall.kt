...
class AuthenticationCall() : FidoServerCall() {
    fun getUafMessageRequest(facetId: String, isTransaction: Boolean, authRequestGetUrl: String): String {
        val serverResponse = Curl.get(authRequestGetUrl)
